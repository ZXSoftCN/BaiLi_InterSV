...
namespace UFIDA.U9.Cust.ZX.BaiLiSV
{
    ...
    public class CreateItemMasterSVStub : ServiceStubBase, ICreateItemMasterSV
    {
        #region ICreateItemMasterSV Members

        //[OperationBehavior]
        public System.String Do(IContext context ,out IList<MessageBase> outMessages, System.String contextInfo, System.String itemModule, System.String itemInfo)
        {
			
			ICommonDataContract commonData = CommonDataContractFactory.GetCommonData(context, out outMessages);
			return DoEx(commonData, contextInfo, itemModule, itemInfo);
        }
